...
| 功能 | 说明 | 预估 |
|------|------|------|
| 提醒系统完善 | macOS 系统通知（tauri-plugin-notification）+ 应用内模态弹窗 | 2-3h |
| TabStyle 功能 | 字体/字号/颜色/节点形状/边框/背景 编辑 | 1-2h |
| 图标库 | 内置 SVG 图标分类选择器 | 1-2h |
| 大纲视图编辑 | TabOutline 点击跳转 + 双击编辑 | 1h |

### P2（增强能力）

| 功能 | 说明 | 预估 |
|------|------|------|
| 全文搜索 | Cmd+F 跨节点搜索 + 高亮 | 1-2h |
| SVG/PDF 导出 | 矢量导出 | 1h |
| FreeMind .mm 导入 | 兼容老牌格式 | 0.5h |
| 明暗主题 | 偏好设置有选项，CSS 未实现切换 | 1h |
| 节点折叠/展开 | Cmd+. 折叠子树 | 0.5h |

### P3（体验打磨）

| 功能 | 说明 | 预估 |
|------|------|------|
| 大型图虚拟滚动 | 1000+ 节点性能 | 3-5h |
| 小地图 | 右下角 minimap | 1-2h |
| 单例检测 | 重复打开激活已有窗口 | 0.5h |
| 节点关联线 | 非父子箭头关联 | 1-2h |
| 自动布局 | 导入后整理 | 2-3h |
